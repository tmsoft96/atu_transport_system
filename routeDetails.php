        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm ">
                                <div class="form-group">
                                    <label for="phoneNumber" class="cH2">Enter phone number used in this tansaction</label>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="book-submit" class="btn btn-success cButton">Book</button>
                </div>
            </div>
